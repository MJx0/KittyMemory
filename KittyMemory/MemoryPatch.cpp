...
std::string MemoryPatch::get_CurrBytes() const
{
    ...
    return KittyUtils::Data::toHex(reinterpret_cast<const void *>(_address), _size);
}
...
std::string MemoryPatch::get_OrigBytes() const
{
    ...
    return KittyUtils::Data::toHex(_orig_code.data(), _orig_code.size());
}
...
std::string MemoryPatch::get_PatchBytes() const
{
    ...
    return KittyUtils::Data::toHex(_patch_code.data(), _patch_code.size());
}